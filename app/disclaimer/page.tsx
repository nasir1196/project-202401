const Disclaimer = () => {
  return (
    <div>
      <h1>Disclaimer for 2abbu</h1>

      <p>
        If you require any more information or have any questions about our
        {"site's"} disclaimer, please feel free to contact us by email at
        2abbu3@gmail.com. Our Disclaimer was generated with the help of the
        
        .
      </p>

      <h2>Disclaimers for 2buu eCommerce</h2>

      <p>
        All the information on this website - www.2abbu.com - is published in
        good faith and for general information purpose only. 2buu eCommerce does
        ...
        on this website (2buu eCommerce), is strictly at your own risk. 2buu
        eCommerce will not be liable for any losses and/or damages in connection
