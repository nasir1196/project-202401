    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            or Our in this Agreement) refers to E-Commerce, Bangladesh.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 2ABBU, accessible from{" "}
            <a
              href="https://www.2abbu.com"
      ...
      <ul>
        <li>
          ...
          <a
            href="www.2abbu.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            www.2abbu.com/contact
          </a>
        </li>
      </ul>
    </div>
